...
public class FacetExecutor {
  ...
  public FacetExecutor(I_FabSystem system, I_RoutineFabricateFactory factory) {
    factory_ = factory;
    log_ = system.getLog();
    system_ = system;
  }
  
  public I_FailureTransport run(final String facetName, final I_FacetSetup setup, FabricationMemoryMutant<Object> memory) {
