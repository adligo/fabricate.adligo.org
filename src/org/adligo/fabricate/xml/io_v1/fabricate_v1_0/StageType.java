 ...
 *         &lt;element name="task" type="{http://www.adligo.org/fabricate/xml/io_v1/fabricate_v1_0.xsd}optional_routine_type" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class StageType {
    ...
    protected List<OptionalRoutineType> task;
     ...
     * {@link OptionalRoutineType }
     * 
     * 
     */
    public List<OptionalRoutineType> getTask() {
        if (task == null) {
            task = new ArrayList<OptionalRoutineType>();
        }
        return this.task;
    }
