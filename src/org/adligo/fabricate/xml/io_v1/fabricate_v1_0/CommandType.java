 ...
 *         &lt;element name="task" type="{http://www.adligo.org/fabricate/xml/io_v1/fabricate_v1_0.xsd}command_task_type" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class CommandType {
    ...
    protected List<CommandTaskType> task;
     ...
     * {@link CommandTaskType }
     * 
     * 
     */
    public List<CommandTaskType> getTask() {
        if (task == null) {
            task = new ArrayList<CommandTaskType>();
        }
        return this.task;
    }
