 ...
 *         &lt;element name="stage" type="{http://www.adligo.org/fabricate/xml/io_v1/common_v1_0.xsd}routine_params_parent_type" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ProjectStagesType {
    ...
    protected List<RoutineParamsParentType> stage;
     ...
     * 
     */
    public List<RoutineParamsParentType> getStage() {
        if (stage == null) {
            stage = new ArrayList<RoutineParamsParentType>();
        }
        return this.stage;
    }
