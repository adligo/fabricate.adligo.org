 ...
 *         &lt;element name="task" type="{http://www.adligo.org/fabricate/xml/io_v1/project_v1_0.xsd}project_task_type" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ProjectStageType {
    ...
    protected List<ProjectTaskType> task;
     ...
     * 
     */
    public List<ProjectTaskType> getTask() {
        if (task == null) {
            task = new ArrayList<ProjectTaskType>();
        }
        return this.task;
    }
