 ...
 *         &lt;element name="command" type="{http://www.adligo.org/fabricate/xml/io_v1/common_v1_0.xsd}routine_params_parent_type" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class FabricateProjectType {
    ...
    protected List<RoutineParamsParentType> command;
     ...
     * {@link RoutineParamsParentType }
     * 
     * 
     */
    public List<RoutineParamsParentType> getCommand() {
        if (command == null) {
            command = new ArrayList<RoutineParamsParentType>();
        }
        return this.command;
    }
